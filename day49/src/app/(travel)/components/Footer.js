      ...
      <div className="flex flex-col mx-auto mb-[75px] max-w-[1500px] h-auto">
        <div className="flex lg:items-center lg:justify-between flex-col lg:flex-row gap-y-[45px] py-[30px] lg:py-0 px-[15px] sm:px-[30px] md:px-[40px] lg:px-[50px] xl:px-[75px] w-full h-auto lg:h-[380px] bg-white">
          <div className="lg:w-4/12">
            <div className="flex items-center justify-center gap-x-[8px] mb-[30px] text-gray-900">
              <i className="fa-solid fa-2xl fa-laptop-code" />
        ...
        <div className="flex items-center justify-evenly sm:justify-between flex-col sm:flex-row sm:px-[30px] md:px-[40px] lg:px-[50px] xl:px-[75px] w-full h-[100px] bg-gray-200">
          ...
          <ul className="flex gap-[15px] text-gray-600 cursor-pointer">
            ...
            <li className="ease-in duration-200 hover:text-gray-400">
              <i className="fa-brands fa-xl fa-facebook" />
            </li>
            <li className="ease-in duration-200 hover:text-gray-400">
              <i className="fa-brands fa-xl fa-github" />
            </li>
            <li className="ease-in duration-200 hover:text-gray-400">
              <i className="fa-brands fa-xl fa-angellist" />
            </li>
            <li className="ease-in duration-200 hover:text-gray-400">
              <i className="fa-brands fa-xl fa-dribbble" />
            </li>
          </ul>
        </div>
      </div>
