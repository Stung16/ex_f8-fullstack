...
//     let data = await GetMindMap(user?.sub, idmap);
...
//     const idSub = await getUserId();
//     // console.log(idSub);
//     const data = await GetMindMap(idSub, idmap);
//     // console.log(data);
...
//             onChange={handleChangeTitle}
//             readOnly={check ? false : true}
//             defaultValue={process.env.NEXT_PUBLIC_TITLE_DEFAULT}
//             onDoubleClick={() => {
//               setCheck(true);
//             }}
//             onBlur={() => {
...
//             onChange={handleChangeDesc}
//             readOnly={check ? false : true}
//             defaultValue={process.env.NEXT_PUBLIC_DESC_DEFAULT}
//             onDoubleClick={() => {
//               setCheck(true);
//             }}
//             onBlur={() => {
